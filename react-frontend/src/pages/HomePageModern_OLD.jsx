    ...
    <div className="athena-home bg-surface text-on-surface font-body selection:bg-primary-container selection:text-on-primary-container">
      ...
      <header className="fixed top-0 w-full z-50 bg-slate-50/60 dark:bg-slate-950/60 backdrop-blur-xl shadow-[0px_20px_40px_rgba(11,28,48,0.06)] flex justify-between items-center px-8 h-20 max-w-full mx-auto">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <a className="font-headline font-bold tracking-tight text-slate-600 dark:text-slate-400 hover:bg-emerald-50/50 transition-all px-2 rounded" href="#technology">Technology</a>
            ...
            <div className="z-10 space-y-8">
              ...
              <div className="flex items-center gap-6 pt-4">
                <div className="flex -space-x-3">
                  <img alt="User" className="w-10 h-10 rounded-full border-2 border-surface object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuB0NeayM3WfLGA9BZ7dkOdJxwy5yc6GxAQhudl4wUgHCHgP9CZH193e8T2KnbUWespZ1QSc9YBjsxONHNJ-Cyv1qWk4FE-7eAmuKmbe1N9RBdQOg-ED8qhjQ-F8p3W2zvBp0uJRusN6cxtI5N4UU_arsex3KJnMUDgRM138Gtza2q_Bvmld4YFWQtsi8VhvAhGyJGcfKmyrJBv4OsKswSSs6iNQHPFscAXKt0-yBaGD5jpdZoUKOmiNr25M1rrt1IPTtyivyuvm87mn" />
                  <img alt="User" className="w-10 h-10 rounded-full border-2 border-surface object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCVSBWqXYzCPa6uwtvaTNE8YeJBsPUK5T3o3dAtdqRGc3poaN3FPMFHgPp9FFzjDUjENCvzTypO4E7T9RN0FTvZGoqnYW0sXizCb8Moe6FQf3ITKfCZStAYL3-CAQgjBgOM86FzyFE5M-YFBuw-uiv1TCSN8Nr9fOB3JzIV5-vE6uPW3ZPt2-Vf7Wj6yZ9k7fTvDpjhj837tVZeeInPmAj-RW1Ird_MzPQ-OxSc1qbzaKPo88QWXdyQWlzl6sSwYIlS0CKndVeTQpdY" />
                  <img alt="User" className="w-10 h-10 rounded-full border-2 border-surface object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAE8ONdIdBJQJIT55I5tiAaOII7ZcChqE5jbBysOwdkzWzdVyB6k03kGc4C6NQrkhMI_ui9it4AN19rli4Hoea4F691Fjp8w-4S9Q7iwGc3fma3NTcTBUMJJw4uj_0ZX7cjlBWH1eAzWhYHTMvtI-J9ih2fv7fVUj-EYXaemgplQrMSNHe_xq7gcn-KOyJlXAg7CU4C2z9M5RIFHyF27PI1k_tyk4dFxZ3P0cnKgxAx7E6mn8MuY4JbBWTHg4IwJ6LLLGKW2EqvMeSP" />
                </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-2 gap-6 h-auto md:h-[600px]">
              ...
              <div className="md:col-span-2 md:row-span-2 bg-surface-container-lowest rounded-lg p-10 flex flex-col justify-between group overflow-hidden relative shadow-sm">
                ...
                <div className="absolute -bottom-10 -right-10 w-2/3 opacity-20 group-hover:scale-110 transition-transform duration-700">
                  <img alt="High-fidelity digital human face with circuitry" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCKWl1hp-NvofzKH3ffDNKi2xX9LK8N5-DkqUNhBiLKI4YjJ-FVaIgMHf6CV6yO3gDSPJ2r4Kc4eTtNLOOSgRfxz0C8aXYqEzxVLk80e8wAla22EBJjgG77hgsDEM5BknVsIGRYECafycRMGplFhB9DE0KeausRUNSVMFEXvn4HBpJFKEsZpa4OWbhJhbTE73_19AxBowdrztBaQC_YAFHewNHWpysdEep1Eln1JIsW45XesfPc4ofOLH9b3Zhs3MtBljK7_A4t5W_Q" />
                </div>
              </div>
              {/* Feature 2 */}
      ...
      <footer className="bg-slate-100 dark:bg-slate-900 w-full py-12">
        <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <a className="text-slate-400 hover:text-emerald-600" href="#"><span className="material-symbols-outlined">share</span></a>
              <a className="text-slate-400 hover:text-emerald-600" href="#"><span className="material-symbols-outlined">public</span></a>
              <a className="text-slate-400 hover:text-emerald-600" href="#"><span className="material-symbols-outlined">mail</span></a>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <nav className="flex flex-col gap-2">
                <a className="font-['Inter'] text-xs uppercase tracking-widest text-slate-500 dark:text-slate-400 hover:text-emerald-400 transition-colors" href="#">Documentation</a>
                <a className="font-['Inter'] text-xs uppercase tracking-widest text-slate-500 dark:text-slate-400 hover:text-emerald-400 transition-colors" href="#">API Reference</a>
                <a className="font-['Inter'] text-xs uppercase tracking-widest text-slate-500 dark:text-slate-400 hover:text-emerald-400 transition-colors" href="#">Changelog</a>
              </nav>
            </div>
            <div className="space-y-4">
              <h6 className="font-headline font-bold text-slate-900 dark:text-slate-100">Legal</h6>
              <nav className="flex flex-col gap-2">
                <a className="font-['Inter'] text-xs uppercase tracking-widest text-slate-500 dark:text-slate-400 hover:text-emerald-400 transition-colors" href="#">Security</a>
                <a className="font-['Inter'] text-xs uppercase tracking-widest text-slate-500 dark:text-slate-400 hover:text-emerald-400 transition-colors" href="#">Privacy Policy</a>
                <a className="font-['Inter'] text-xs uppercase tracking-widest text-slate-500 dark:text-slate-400 hover:text-emerald-400 transition-colors" href="#">Terms of Service</a>
              </nav>
            </div>
          </div>
        ...
        <section id="top" className="relative min-h-[795px] flex items-center overflow-hidden px-8">
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center w-full">
            <div className="z-10 space-y-8">
              <span className="bg-tertiary-fixed text-on-tertiary-fixed px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest font-label">The Future of Interaction</span>
              <h2 className="text-6xl md:text-7xl font-headline font-extrabold text-on-surface leading-[1.1] tracking-tight">Real-Time <span className="text-primary italic">AI Avatar</span> Conversations</h2>
              <p className="text-xl text-on-surface-variant max-w-xl leading-relaxed">Deploy photorealistic digital humans integrated with Unreal Engine 5. Experience human-like responsiveness with sub-120ms latency.</p>
              <div className="flex flex-wrap gap-4">
                <button onClick={() => onNavigate('auth')} className="px-8 py-4 bg-gradient-to-br from-primary to-primary-container text-on-primary rounded-full font-bold text-lg shadow-lg hover:shadow-primary/20 transition-all">Get Started Free</button>
                <button onClick={onLaunchDemo} className="px-8 py-4 bg-secondary-container text-on-secondary-container rounded-full font-bold text-lg hover:opacity-90 transition-all flex items-center gap-2"><span className="material-symbols-outlined">play_circle</span>Watch Showcase</button>
              </div>
              <div className="flex items-center gap-6 pt-4">
                <p className="text-sm font-medium text-on-surface-variant">Trusted by <span className="text-primary font-bold">500+</span> Enterprise Partners</p>
              </div>
            ...
            <div className="relative group">
              <div className="absolute -inset-4 bg-gradient-to-tr from-primary/20 to-secondary/20 rounded-xl blur-3xl opacity-50 group-hover:opacity-75 transition duration-1000"></div>
              <div className="relative bg-surface-container-lowest rounded-xl p-4 shadow-2xl overflow-hidden aspect-[4/5]">
                <img className="w-full h-full object-cover rounded-lg" alt="AI Avatar" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAMQj1fbdY_MRCJwyFbBhQPjcELkcczBY75n7_yBgO8msFNwbVuF6OJPwWwlgwLN7i3NEgOv56jUwffaoL5UbtaaSjRYHxWCOMdvPsvuCJVdHKIcHD0XJ7XcMrg-JAoUHa6qTNjEFv519dMfWuWFMkXQoC73ujYPQD_3Riog_j8Oimq3Kxbcig5b6lQRfsnzPoUKSPXxES428SwSJw0h_z7x1tlLE4f6zOl2icX_LKc2-fpmUx_wAglr7aCVQotvrKvHrSJFe5AoCiF" />
                <div className="absolute bottom-8 left-8 right-8 glass-card p-6 rounded-lg border-outline-variant/10">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs font-bold text-primary font-label uppercase">Status: Live Sync</span>
                    <span className="flex h-2 w-2 rounded-full bg-primary-container animate-pulse"></span>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-2 gap-6 h-auto md:h-[600px]">
              <div className="md:col-span-2 md:row-span-2 bg-surface-container-lowest rounded-lg p-10 flex flex-col justify-between group overflow-hidden relative shadow-sm">
                <div className="z-10">
                  <span className="material-symbols-outlined text-primary text-4xl mb-6">verified_user</span>
                  <h4 className="text-3xl font-headline font-bold mb-4">Photorealistic Avatars</h4>
                  <p className="text-on-surface-variant text-lg">Our proprietary rendering stack creates digital humans with cinematic detail for enterprise-grade interactions.</p>
                </div>
              </div>
              <div className="md:col-span-1 bg-primary text-on-primary rounded-lg p-8 flex flex-col justify-center gap-4 hover:bg-on-primary-fixed-variant transition-colors">
                <span className="material-symbols-outlined text-3xl">bolt</span>
                <h4 className="text-xl font-bold">120ms Latency</h4>
                <p className="text-sm opacity-80">The fastest conversational loop from audio to visual.</p>
              </div>
              <div className="md:col-span-1 bg-secondary-container text-on-secondary-container rounded-lg p-8 flex flex-col justify-center gap-4">
                <span className="material-symbols-outlined text-3xl">language</span>
                <h4 className="text-xl font-bold">Global Scale</h4>
                <p className="text-sm opacity-80">Native support for 45+ languages and accents.</p>
              </div>
              <div className="md:col-span-2 bg-surface-container-high rounded-lg p-8 flex items-center justify-between group">
                <div className="max-w-[60%]">
                  <h4 className="text-xl font-bold mb-2">Privacy First Architecture</h4>
                  <p className="text-sm text-on-surface-variant">SOC2-style controls with encrypted session transport and auditability.</p>
                </div>
                <span className="material-symbols-outlined text-5xl text-primary/30 group-hover:text-primary transition-colors">shield_lock</span>
              </div>
            </div>
        ...
        <section className="py-20 bg-inverse-surface text-inverse-on-surface">
          <div className="max-w-7xl mx-auto px-8 grid grid-cols-2 lg:grid-cols-4 gap-12 text-center">
            {[
              ...
              <div className="space-y-2" key={item[1]}>
                <p className="text-5xl font-headline font-black text-primary-fixed">{item[0]}</p>
                <p className="text-sm uppercase tracking-widest font-label opacity-70">{item[1]}</p>
              </div>
            ))}
          </div>
        </section>
