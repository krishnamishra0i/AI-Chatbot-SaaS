...
Generate answers using Google AI API with correct model
"""
...
def check_available_models():
    """Check available models for Google AI API"""
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            for model in models.get('models', []):
                ...
                print(f"     - Display Name: {model.get('displayName', 'Unknown')}")
                print(f"     - Description: {model.get('description', 'Unknown')[:100]}...")
                print()
            return models
        else:
    ...
    for model in models_to_try:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"❌ Model {model} - {response.status_code}: {response.text[:100]}...")
...
def create_working_integration():
    """Create working Google AI integration"""
    
    print("="*80)
    print("🚀 CREATING WORKING GOOGLE AI INTEGRATION")
    print("="*80)
    ...
    working_model = test_correct_model()
    ...
    if working_model:
        ...
        integration_code = f'''
# GOOGLE AI API INTEGRATION FOR LMS-ATHENA
# Working integration with model: {working_model}
...
class GoogleAIIntegration:
    ...
    def __init__(self):
        ...
        self.model = "{working_model}"  # Working model
        self.timeout = 30
...
'''
        ...
        # Save the working integration
        with open('google_ai_integration_working.py', 'w') as f:
            f.write(integration_code)
        
        print(f"\n✅ Created working integration with model: {working_model}")
        print("✅ Saved as google_ai_integration_working.py")
        print("✅ Ready to integrate into your chatbot!")
